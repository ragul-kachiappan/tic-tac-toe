...
def minimax_algorithm(
    ...
    if is_max_player:
        ...
        for position in board_object.free_spaces:
            ...
            calculated_value, _, _ = minimax_algorithm(board_object=copy(board_object), is_max_player=False, row=row, col=col)
        ...
        for position in board_object.free_spaces:
            ...
            board_object.free_spaces.remove(position)
            calculated_value, _, _ = minimax_algorithm(board=copy(board_object), is_max_player=True, row=row, col=col)
